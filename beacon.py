...
parser.add_argument('-n', action="store", dest="name", help='device name', default=None)
...
if args.monitor_ubertooth:
    ...
    april_fools.celebrate(lambda x: advertise.advertise(advertising_address=x, name=name), n_ident=args.af_num, n_total=args.af_total, af_test=args.af_test, af_target=args.af_target)
else:
